...
-- changeset tien:001-create-r2dbc-event-journal-table
...
-- changeset tien:001-create-r2dbc-event-journal-slice-idx runInTransaction:false
CREATE INDEX IF NOT EXISTS event_journal_slice_idx ON event_journal(slice, entity_type, db_timestamp, seq_nr);

-- changeset tien:001-create-r2dbc-snapshot-table
...
-- changeset tien:001-create-r2dbc-durable-state-table
...
-- changeset tien:001-create-r2dbc-durable-state-slice-idx runInTransaction:false
...
-- changeset tien:001-create-r2dbc-projection-offset-store-table
...
-- changeset tien:001-create-r2dbc-projection-timestamp-offset-store-table
...
-- changeset tien:001-create-r2dbc-projection-management-table
