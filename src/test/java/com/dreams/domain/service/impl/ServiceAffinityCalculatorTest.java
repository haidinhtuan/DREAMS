...
class DefaultAffinityCalculationServiceTest {
    ...
    void calculateDataAffinity_correctRatio() {
        Microservice ms2 = new Microservice("ms2", "svc2", false, clusterB, new HashMap<>(), new HashMap<>(), null, null, null, 0, 0, 0);
        Microservice ms3 = new Microservice("ms3", "svc3", false, clusterB, new HashMap<>(), new HashMap<>(), null, null, null, 0, 0, 0);

        Map<Microservice, Double> dataExchanged = new HashMap<>();
        dataExchanged.put(ms2, 60.0);
        dataExchanged.put(ms3, 40.0);

        Microservice ms1 = new Microservice("ms1", "svc1", false, clusterA, new HashMap<>(), dataExchanged, null, null, null, 0, 0, 0);
    ...
    void calculateTotalAffinityImpact_sumsConnectedAffinities() {
        Microservice migrating = new Microservice("ms-migrate", "migrate", false, clusterA, new HashMap<>(), new HashMap<>(), null, null, null, 0, 0, 0);

        Map<Microservice, Double> affinities1 = new HashMap<>();
        affinities1.put(migrating, 50.0);
        Microservice local1 = new Microservice("local1", "local1", false, clusterB, affinities1, new HashMap<>(), null, null, null, 0, 0, 0);

        Map<Microservice, Double> affinities2 = new HashMap<>();
        affinities2.put(migrating, 30.0);
        Microservice local2 = new Microservice("local2", "local2", false, clusterB, affinities2, new HashMap<>(), null, null, null, 0, 0, 0);

        Microservice local3 = new Microservice("local3", "local3", false, clusterB, new HashMap<>(), new HashMap<>(), null, null, null, 0, 0, 0);
    ...
    void calculateTotalAffinityImpact_zeroWhenNoConnections() {
        Microservice migrating = new Microservice("ms-migrate", "migrate", false, clusterA, new HashMap<>(), new HashMap<>(), null, null, null, 0, 0, 0);
        Microservice local1 = new Microservice("local1", "local1", false, clusterB, new HashMap<>(), new HashMap<>(), null, null, null, 0, 0, 0);
